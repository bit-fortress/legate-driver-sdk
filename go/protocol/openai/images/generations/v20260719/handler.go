...
func invalidOpenResponse(cause error) *driver.ImageAttemptOpenResult {
	body := ErrorResponse{Error: ErrorDetail{Message: "Invalid image request.", Type: "invalid_request_error", Code: json.RawMessage(`"invalid_request"`)}}
